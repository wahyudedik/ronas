        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.landing.news.store') }}" class="space-y-4" enctype="multipart/form-data">
                        @csrf
                        @include('admin.landing.news.partials.form', ['newsItem' => null])
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.landing.news.store') }}" class="space-y-4">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="excerpt" name="excerpt" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900">{{ old('excerpt') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="author_image_path" name="author_image_path" class="mt-1 block w-full" :value="old('author_image_path')" />
                        </div>
