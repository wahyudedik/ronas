                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.news.update', $news) }}" class="space-y-4"
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" class="mt-1 block w-full" :value="old('title', $news->title)"
                                required />
                        ...
                        <div>
                            ...
                            <textarea id="excerpt" name="excerpt" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900">{{ old('excerpt', $news->excerpt) }}</textarea>
                        </div>

                        <div>
                            <x-input-label for="content" value="Content" />
                            <textarea id="content" name="content" rows="10"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900">{{ old('content', $news->content) }}</textarea>
                        ...
                        <div>
                            ...
                            @if ($news->author_image)
                                <div class="mb-2">
                                    <img src="{{ asset($news->author_image) }}" alt="Author"
